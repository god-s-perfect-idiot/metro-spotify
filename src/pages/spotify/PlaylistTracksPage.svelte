...
>
	...
	<span class="text-6xl font-[200] h-auto py-1 px-4 truncate" title={playlistName}>{playlistName}</span>
	<div class="flex flex-col gap-4 pb-20 mt-6 overflow-y-auto overflow-x-hidden px-4 h-full">
		{#if isLoading}
